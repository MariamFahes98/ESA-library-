...
// Fetch books from bought_books table
$sql = "SELECT * FROM bought_books JOIN book ON bought_books.BookID = book.BookID";
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<div class='col-12'><p class='text-center'>No books found in your bought list.</p></div>";
            }
            ?>
        </div>
    </div>
