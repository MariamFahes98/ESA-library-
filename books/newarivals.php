...
<body>
    ...
    <div class="container">
        <div class="d-flex book-nav" id="header1" style="justify-content: space-between; padding-top: 10px;">
            <div>
                <a href="./popular.php" class="selected"><i class="fas fa-long-arrow-alt-right" aria-hidden="true"></i>New Arrivals </a>
            </div>
            <div class="lists">
                <ul class="d-flex listss">
                    <li class="d-none d-md-block"><a href="./popular.php" class="gray-text">popular pruducts</a></li>
